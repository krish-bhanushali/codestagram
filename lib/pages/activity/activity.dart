        ...
        child: Column(
          children: [
            Container(
              ...
              height: height * 0.22,
              width: width,
              decoration: BoxDecoration(boxShadow: [BoxShadow(offset: Offset(0, 15), blurRadius: 30, color: Colors.grey[100])]),
              child: ListView(
                scrollDirection: Axis.horizontal,
                children: [
                  RequestCards(
                    height: height,
                    profileUrl: 'https://mir-cdn.behance.net/v1/rendition/project_modules/disp/0f375488029143.5dca2fcc5aafd.jpg',
                    userName: 'Noel',
                    userRole: 'Designer',
                    isAccepted: false,
                  ),
            ...
            Container(
              ...
              child: Text(
                ...
                style: TextStyle(fontSize: 16, fontFamily: 'Avenir', color: Colors.grey[800], fontWeight: FontWeight.bold),
              ),
            ),
            Container(
              ...
              child: ListView(
                ...
                children: [
                  ActivityNotificationTile(
                    ...
                    postUrl: 'https://randomuser.me/api/portraits/men/1.jpg',
                  ),
                  ActivityNotificationTile(
                    height: height,
                    userPhotoUrl: 'https://randomuser.me/api/portraits/men/1.jpg',
